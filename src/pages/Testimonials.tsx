...
const Testimonials: React.FC = () => {
  ...
  // Create a compatible interface for the filters component
  interface FilterableTestimonial extends Testimonial {
    industry: string;
    service: string;
    featured: boolean;
  ...
  const enhancedReviews = reviews.map(review => ({
    ...
    categories: [],
    tags: []
  })) as FilterableTestimonial[];

  const [filteredReviews, setFilteredReviews] = useState<FilterableTestimonial[]>(enhancedReviews);
          ...
          <div className="container-custom">
            ...
            >
              <IndustryServiceFilters
                ...
                onFilteredChange={(filtered) => setFilteredReviews(filtered as FilterableTestimonial[])}
                className="mb-12"
              />
            </motion.div>

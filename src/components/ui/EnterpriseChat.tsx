  ...
  return (
    <div className={`flex h-[600px] ${className}`}>
      ...
      <div className="w-1/3 border-r border-gray-200 dark:border-gray-700 flex flex-col">
        <Card className="p-4 rounded-none rounded-tl-lg" variant="elevated">
      ...
      <div className="flex-1 flex flex-col">
        {/* Chat Header */}
        {selectedParticipant && (
          <Card className="p-4 rounded-none rounded-tr-lg border-b border-gray-200 dark:border-gray-700" variant="elevated">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
        ...
        {/* Message Input */}
        {selectedParticipant && (
          <Card className="p-4 rounded-none rounded-br-lg border-t border-gray-200 dark:border-gray-700" variant="elevated">
